...
public class BrokerApiWebSocketClientImpl implements BrokerApiWebSocketClient, Closeable {
    ...
    private String wsApiQuoteUrl = BrokerConstants.WS_API_BASE_URL;
    private String wsApiUserUrl = BrokerConstants.WS_API_USER_URL;

    private ExecutorService executorService = Executors.newCachedThreadPool();

    public BrokerApiWebSocketClientImpl(OkHttpClient client) {
        this.client = client;
    }
