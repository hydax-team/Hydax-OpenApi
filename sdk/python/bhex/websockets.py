...
class BhexSocketManager(threading.Thread):
    ...
    def __init__(self, api_key='', secret='', entry_point='wss://wsapi.hydax.com/openapi/', auth=True, rest_entry_point='https://api.hydax.com/openapi/'):
    ...
    def _start_socket(self, id_, path, payload, callback):
        ...
        factory = BhexClientFactory(factory_url, useragent='Hydax-P 1.0', payload=payload)
