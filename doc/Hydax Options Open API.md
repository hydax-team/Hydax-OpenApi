...
The base url of hydax open API is: https://www.hydax.com/openapi
...
In the `symbols` field, the endpoint will return information on current actively trading cryptos on hydax. You can ignore this section.
